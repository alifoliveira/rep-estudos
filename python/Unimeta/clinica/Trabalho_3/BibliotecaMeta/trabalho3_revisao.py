...
def titulo_livro():
    ...
    if titulo_test:
        try:
            ...
            pass
        label_livro = Label(window_livro, text='Livro já Cadastrado', font=('', 10, 'bold'), bg='#292929',
                            fg='white')
        label_livro.pack(side=BOTTOM)
    elif len(titulo.get()) < 2:
        try:
            label_livro.destroy()
        except NameError:
            pass
        label_livro = Label(window_livro, text='Mínimo de 2 Caracteres', font=('', 10, 'bold'), bg='#292929',
                            fg='white')
        label_livro.pack(side=BOTTOM)
    else:
        try:
            ...
            pass
        label_livro = Label(window_livro, text='Cadastrado com Sucesso!', font=('', 10, 'bold'), bg='#292929',
                            fg='white')
        return paginas.get()
    db.close()
...
def login_usuario():
    ...
    if usuario_test:
        ...
        try:
            ...
            pass
        label_usuario = Label(window_usuario, text='Mínino de 4 Caracteres', font=('', 10, 'bold'),
                              bg='#292929', fg='white')
        label_usuario.pack(side=BOTTOM)
    else:
        return user.get()
