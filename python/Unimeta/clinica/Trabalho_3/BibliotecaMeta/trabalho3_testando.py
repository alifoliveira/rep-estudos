...
def main():
    ...
    main_menu.add_command(label='Realizar Empréstimo', command=emprestimo)
...
def listar_autor():
    ...
    listbox = Listbox(window_listar_autor, yscrollcommand=s.set)
    ...
    for i in x:
        ...
        listbox.insert(END, f'Nome do Autor:  {i[1]}')
        listbox.insert(END, '------------------------------------------------')
    db.close()
...
def listar_cliente():
    ...
    listbox = Listbox(window_listar_cliente, yscrollcommand=s.set)
    listbox.pack(side=LEFT, fill=BOTH, expand=1)
    s.config(command=listbox.yview)
    ...
    for i in x:
        listbox.insert(END, f'ID:  {i[0]}')
        listbox.insert(END, f'Nome:  {i[1]}')
        listbox.insert(END, f'Rua:  {i[2]}')
        listbox.insert(END, f'Número da Casa:  {i[3]}')
        listbox.insert(END, f'Bairro:  {i[4]}')
        listbox.insert(END, f'Cidade:  {i[5]}')
        listbox.insert(END, f'Estado:  {i[6]}')
        listbox.insert(END, f'Data de Nascimento:  {i[7]}')
        listbox.insert(END, f'Telefone:  {i[8]}')
        listbox.insert(END, f'Celular:  {i[9]}')
        listbox.insert(END, f'E-mail:  {i[10]}')
        listbox.insert(END, f'CPF:  {i[11]}')
        listbox.insert(END, '------------------------------------------------')
    db.close()
...
def listar_livro():
    ...
    listbox = Listbox(window_listar_livro, yscrollcommand=s.set)
    listbox.pack(side=LEFT, fill=BOTH, expand=1)
    s.config(command=listbox.yview)
    ...
    for i in x:
        listbox.insert(END, f'ID:  {i[0]}')
        listbox.insert(END, f'Título do Livro:  {i[1]}')
        listbox.insert(END, f'Número de Páginas:  {i[2]}')
        listbox.insert(END, '------------------------------------------------')
    db.close()
...
def listar_usuario():
    ...
    listbox = Listbox(window_listar_usuario, yscrollcommand=s.set)
    listbox.pack(side=LEFT, fill=BOTH, expand=1)
    s.config(command=listbox.yview)
    ...
    for i in x:
        ...
        listbox.insert(END, f'Senha:  {i[2]}')
        listbox.insert(END, '------------------------------------------------')
    db.close()
